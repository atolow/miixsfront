...
이 약관은 믹시즈(이하 "회사")가 제공하는 서비스의 이용과 관련하여 회사와 회원과의 권리, 의무 및 책임사항, 기타 필요한 사항을 규정함을 목적으로 합니다.
...
"회사"가 약관을 개정할 경우에는 적용일자 및 개정사유를 명시하여 현행약관과 함께 제1항의 방식에 따라 그 개정약관의 적용일자 30일 전부터 적용일자 전일까지 공지합니다. 다만, 회원에게 불리한 약관의 개정의 경우에는 공지 외에 일정기간 서비스내 전자쪽지, 로그인시 동의창 등의 전자적 수단을 통해 따로 명확히 통지하도록 합니다.
...
"회원"은 서비스내 "내 프로필" 화면을 통하여 언제든지 본인의 개인정보를 열람하고 수정할 수 있습니다. 다만, 서비스 관리를 위해 필요한 단말기식별번호, 아이디, 성별, 태어난해 등은 수정이 불가능합니다.
...
자동 접속 프로그램 등을 사용하는 등정상적인 용법과 다른 방법으로 서비스를 이용하여 "회사"의 서버에 부하를 일으켜 회사의 정상적인 서비스를 방해하는 행위
...
아동을 성적으로 착취 또는 학대하는 콘텐츠 또는 이를 조장하는 콘텐츠(모든 아동 성적 학대 콘텐츠가 포함)
...
기타 아동의 안전을 위협하는 모든 콘텐츠

기타 불법적이거나 부당한 행위

"회원"은 관계법, 이 약관의 규정, 이용안내 및 "서비스"와 관련하여 공지한 주의사항, "회사"가 통지하는 사항 등을 준수하여야 하며, 기타 "회사"의 업무에 방해되는 행위를 하여서는 안 됩니다.

"회원"은 서비스 이용 중 문의 또는 민원을 제기할 경우, 회사가 정한 절차에 따라 회원가입 시 등록한 휴대전화번호를 필수로 제공해야 합니다.

"회사"는 이용자의 문의 처리 및 본인 확인을 위하여, 제공받은 휴대전화번호를 본인 식별, 계정 연동 여부 확인, 서비스 이용기록 조회 등의 목적으로만 사용합니다.

"회원"은 회원가입 시 기재한 휴대전화번호와 불일치하거나 확인이 불가능한 경우, 본인 확인이 이루어지지 않아 문의 접수가 제한될 수 있습니다.
...
"서비스"의 내용, 이용방법, 이용시간에 대하여 변경 또는 서비스 중단이 있는 경우에는 변경 또는 중단될 서비스의 내용 및 사유와 일자 등은 그 변경 또는 중단 전에 "회사" "웹사이트" 또는 서비스내 "공지사항" 화면, 기타 메시지 등 회원이 충분이 인지할 수 있는 방법으로 [30]일의 기간을 두고 사전에 공지합니다.

제 14 조 (정보의 제공 및 광고의 게재)

"회사"는 "회원"이 "서비스" 이용 중 필요하다고 인정되는 다양한 정보를 서비스내 "공지사항", 서비스 화면, 메시지, 전자우편 등의 방법으로 "회원"에게 제공할 수 있습니다. 다만, "회원"은 관련법에 따른 거래관련 정보 및 고객문의 등에 대한 답변 등을 제외하고는 언제든지 위 정보제공에 대해서 수신 거절을 할 수 있습니다.

"회사"는 "서비스"의 운영과 관련하여 서비스 화면, 메시지, 홈페이지 등에 광고를 게재할 수 있습니다.
...
게시중단요청서비스 : admin@miixs.com

제 17 조 (권리의 귀속)

"서비스"에 대한 저작권 및 지적재산권은 "회사"에 귀속됩니다. 단, "회원"의 "게시물" 및 제휴계약에 따라 제공된 저작물 등은 제외합니다.

"회사"가 제공하는 서비스의 디자인, "회사"가 만든 텍스트, 그래픽, "회원" 상호간 전송 기능 등 "회사"가 제공하는 서비스에 관련된 모든 상표, 서비스 마크, 로고 등에 관한 저작권 기타 지적재산권은 대한민국 및 외국의 법령에 기하여 "회사"가 보유하고 있거나 "회사"에게 소유권 또는 사용권이 있습니다.
...
"회원"은 명시적으로 허락된 내용을 제외하고는 "서비스"를 통해 얻어지는 "회원" 상태정보를 영리 목적으로 사용, 복사, 유통하는 것을 포함하여 "회사"가 만든 텍스트, 그래픽의 "회원" 상호간 전송기능 등을 복사하거나 유통할 수 없습니다.
...
"회원"이 계약을 해지하는 경우, "회원"이 작성한 게시물 일체는 삭제됩니다. 다만 타인과의 대화 등은 삭제되지 않습니다.

제 19 조 (이용제한 등)

"회사"는 "회원"이 이 약관의 의무를 위반하거나 "서비스"의 정상적인 운영을 방해한 경우, 경고, 일시정지, 영구이용정지 등으로 "서비스" 이용을 단계적으로 제한할 수 있습니다.

"회사"는 "회원"이 이용 제한이 3개월이 지난 계정에 대해서는 정지 사유를 안내하거나 이용 제한 해제를 거부할 수 있습니다.
...
"회사"는 "회원"이 성별을 허위로 기재하거나 속였다고 판단되는 경우, 내부 운영정책에 따라 "회원"에게 해당 정보의 인증을 요구할 수 있습니다. 해당 정보가 인증될 때까지 "회사"는 해당 계정의 이용을 제한할 수 있습니다.

"회사"는 "회원"이 계속해서 3개월 이상 로그인하지 않는 경우, 회원정보의 보호 및 운영의 효율성을 위해 자동으로 계정이 탈퇴 처리됩니다.

"회사"는 회원 간 분쟁으로 인해 고소, 고발, 민원 등 법적 절차가 개시되거나 수사기관으로부터 회원 관련 자료 제출을 요구받은 경우, 해당 사건의 성격상 가해자와 피해자의 구분이 불명확하거나 법적 절차가 서비스 질서를 현저히 저해할 우려가 있다고 판단될 때, 관련 "회원"의 서비스 이용을 일시적 또는 영구적으로 제한할 수 있습니다.
...
제3자가 "서비스"를 이용하여 불법적으로 전송, 유포하거나 또는 전송유포되도록 한 모든 바이러스, 스파이웨어 및 기타 악성 프로그램으로 인한 손해
...
인앱결제의 상품은 구매 후 사용하지 않았고 구매한지 7일이 지나지 않은 상품에 대하여 환불 요청이 가능합니다.

서비스 탈퇴시 인앱결제로 구매하신 상품의 경우 복원이 불가능합니다.
