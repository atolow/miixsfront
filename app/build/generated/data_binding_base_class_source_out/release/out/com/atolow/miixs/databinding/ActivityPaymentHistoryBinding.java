...
public final class ActivityPaymentHistoryBinding implements ViewBinding {
  ...
  private ActivityPaymentHistoryBinding(@NonNull CoordinatorLayout rootView,
      @NonNull ProgressBar progressBar, @NonNull RecyclerView rvPaymentHistory,
      @NonNull SwipeRefreshLayout swipeRefreshLayout, @NonNull MaterialToolbar toolbar,
      @NonNull TextView tvEmpty) {
    this.rootView = rootView;
    this.progressBar = progressBar;
    this.rvPaymentHistory = rvPaymentHistory;
  ...
  public static ActivityPaymentHistoryBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      id = R.id.rvPaymentHistory;
      RecyclerView rvPaymentHistory = ViewBindings.findChildViewById(rootView, id);
      ...
      return new ActivityPaymentHistoryBinding((CoordinatorLayout) rootView, progressBar,
          rvPaymentHistory, swipeRefreshLayout, toolbar, tvEmpty);
    }
