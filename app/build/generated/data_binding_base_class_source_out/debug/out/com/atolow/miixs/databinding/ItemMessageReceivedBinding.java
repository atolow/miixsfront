...
public final class ItemMessageReceivedBinding implements ViewBinding {
  ...
  private ItemMessageReceivedBinding(@NonNull ConstraintLayout rootView,
      @NonNull ImageView ivMessageImage, @NonNull ImageView ivProfile,
      @NonNull LinearLayout llMessageBubble, @NonNull TextView tvMessage,
  ...
  public static ItemMessageReceivedBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      return new ItemMessageReceivedBinding((ConstraintLayout) rootView, ivMessageImage, ivProfile,
