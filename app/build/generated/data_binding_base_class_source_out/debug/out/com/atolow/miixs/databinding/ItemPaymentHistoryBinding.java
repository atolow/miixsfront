...
public final class ItemPaymentHistoryBinding implements ViewBinding {
  ...
  private ItemPaymentHistoryBinding(@NonNull MaterialCardView rootView, @NonNull TextView tvAmount,
      @NonNull TextView tvCashAmount, @NonNull TextView tvDate, @NonNull TextView tvPaymentMethod,
      @NonNull TextView tvStatus) {
    this.rootView = rootView;
    this.tvAmount = tvAmount;
    this.tvCashAmount = tvCashAmount;
    this.tvDate = tvDate;
  ...
  public static ItemPaymentHistoryBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      id = R.id.tvCashAmount;
      TextView tvCashAmount = ViewBindings.findChildViewById(rootView, id);
      ...
      return new ItemPaymentHistoryBinding((MaterialCardView) rootView, tvAmount, tvCashAmount,
          tvDate, tvPaymentMethod, tvStatus);
    }
